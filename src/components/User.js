...
export default props => {
    ...
    const descStyle = props.dataCancelU !== null ?
    ...
    const rightContent = [
        <TouchableOpacity
            ...
            onPress={() => props.onDelete(props.users_id)}>
    ...
    return (
        <Swipeable leftActionActivationDistance={200}
            ...
            onLeftActionActivate={() => props.onDelete(props.users_id)}
            leftContent={leftContent} rightButtons={rightContent}>
            <View style={styles.container}>
                <TouchableWithoutFeedback onPress={() => props.onUpdate(props.users_id)}>
