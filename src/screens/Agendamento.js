...
//---------------------------------------------------------------------------------------
    AddAgendamentos = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/agendamentos`, {
                agendamentosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateAgendamentos = async  agendamento  => {
        const data = new Date()
        console.log(data.getHours())
        try {
            await axios.put(`${server}/agendamentos/atualisa`, {
                agendamentos_id: dados.id,
                agendamentosDataUpdate: new Date(),

                agendamentosDataAgendamento: agendamento.agendamentosDataAgendamento,
                agendamentosHoraAgendamento: agendamento.agendamentosHoraAgendamento,
                agendamentosVolume: agendamento.agendamentosVolume,
                agendamentosFornecedor: agendamento.agendamentosFornecedor,
                agendamentosCPD: agendamento.agendamentosCPD,
                agendamentosDataExecu: agendamento.agendamentosDataExecu,
                agendamentosEntSai: agendamento.agendamentosEntSai,
                agendamentosConferencia: agendamento.agendamentosConferencia,
                agendamentosObservacao: agendamento.agendamentosObservacao                
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddAgendamento {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateAgendamentos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Controle de Agendamento</Text>
                        <View style={styles.linha} />
                    </View>
