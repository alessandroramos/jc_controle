...
import AddCanc_desconto from './AddCanc_desconto'
...
export default class Canc_desconto extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddCanc_descontos = async  locData  => {
...
//--------------------------------------------------------------------------------------- 
    updateCanc_descontos = async  canc_desconto  => {
        const data = new Date()
        console.log(data.getHours())
        try {
            await axios.put(`${server}/canc_descontos/atualisa`, {
                canc_descontos_id: dados.id,
                canc_descontosDataUpdate: new Date(),
                canc_descontosDocNum: canc_desconto.canc_descontosDocNum,
                canc_descontosValor: canc_desconto.canc_descontosValor,
                canc_descontosAcao: canc_desconto.canc_descontosAcao,
                canc_descontosMotivo: canc_desconto.canc_descontosMotivo,
                canc_descontosFiscal: canc_desconto.canc_descontosFiscal,
                canc_descontosPrevencao: canc_desconto.canc_descontosPrevencao, 
                canc_descontosObservacao: canc_desconto.canc_descontosObservacao                
            })
...
//---------------------------------------------------------------------------------------    
    abriAdd = () =>{
        Geolocation.getCurrentPosition((locData)=>{
            this.AddCanc_descontos(locData)
        }, (erro)=>{
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddCanc_desconto {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateCanc_descontos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Controle de Canc_desconto</Text>
                        <View style={styles.linha} />
                    </View>
