...
//---------------------------------------------------------------------------------------
    AddDoacaos = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/doacaos`, {
                doacaosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updateDoacaos = async  doacao  => {
        const data = new Date()
        console.log(data.getHours())
        try {
            await axios.put(`${server}/doacaos/atualisa`, {
                doacaos_id: dados.id,
                doacaosDataUpdate: new Date(),

                doacaosData: doacao.doacaosData,
                doacaosHora: doacao.doacaosHora,
                doacaosNota: doacao.doacaosNota,
                doacaosEntidade: doacao.doacaosEntidade,
                doacaosSetor: doacao.doacaosSetor,
                doacaosProduto: doacao.doacaosProduto,
                doacaosQuantidade: doacao.doacaosQuantidade,
                doacaosResponsavel: doacao.doacaosResponsavel,
                doacaosConferente: doacao.doacaosConferente,
                doacaosObservacao: doacao.doacaosObservacao                
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddDoacao {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateDoacaos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Controle de Doacao</Text>
                        <View style={styles.linha} />
                    </View>
