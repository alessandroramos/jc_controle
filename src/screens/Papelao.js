...
import AddPapelao from './AddPapelao'
...
export default class Papelao extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//---------------------------------------------------------------------------------------
    AddPapelaos = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/papelaos`, {
                papelaosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updatePapelaos = async  papelao  => {
        const data = new Date()
        console.log(data.getHours())
        try {
            await axios.put(`${server}/papelaos/atualisa`, {
                papelaos_id: dados.id,
                papelaosDataUpdate: new Date(),
                papelaosData: new Date(),

                papelaosPeso: papelao.papelaosPeso,
                papelaosMaterial: papelao.papelaosMaterial,
                papelaosResponsavel: papelao.papelaosResponsavel,
                papelaosPrevencao: papelao.papelaosPrevencao,
                papelaosPrevencao: papelao.papelaosPrevencao, 
                papelaosObservacao: papelao.papelaosObservacao                
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddPapelao {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updatePapelaos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Controle de Papelao</Text>
                        <View style={styles.linha} />
                    </View>
