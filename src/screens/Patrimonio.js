...
//---------------------------------------------------------------------------------------
    AddPatrimonios = async  locData  => {
        this.setState({loading: true})
        try {
            const res = await axios.post(`${server}/patrimonios`, {
                patrimoniosDataCadastro: new Date(), 
...
//--------------------------------------------------------------------------------------- 
    updatePatrimonios = async  patrimonio  => {
        const data = new Date()
        console.log(data.getHours())
        try {
            await axios.put(`${server}/patrimonios/atualisa`, {
                patrimonios_id: dados.id,
                patrimoniosDataUpdate: new Date(),

                patrimoniosDataAquisicao: patrimonio.patrimoniosDataAquisicao,
                patrimoniosNota: patrimonio.patrimoniosNota,
                patrimoniosEquipamento: patrimonio.patrimoniosEquipamento,
                patrimoniosnumSerie: patrimonio.patrimoniosnumSerie,
                patrimoniosModelo: patrimonio.patrimoniosModelo,
                patrimoniosSetor: patrimonio.patrimoniosSetor,
                patrimoniosLocal: patrimonio.patrimoniosLocal,
                patrimoniosResponsavel: patrimonio.patrimoniosResponsavel, 
                patrimoniosObservacao: patrimonio.patrimoniosObservacao                
            })
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddPatrimonio {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updatePatrimonios}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Controle de Patrimonio</Text>
                        <View style={styles.linha} />
                    </View>
