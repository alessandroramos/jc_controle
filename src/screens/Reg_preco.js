...
import AddReg_preco from './AddReg_preco'
...
export default class Reg_preco extends Component {
    state = {
        acessoemps: [],
        usuario: [],
        visible: [],
...
//--------------------------------------------------------------------------------------- 
    updateReg_precos = async  reg_preco  => {
        const data = new Date()
        console.log(data.getHours())
        try {
            await axios.put(`${server}/reg_precos/atualisa`, {
                reg_precos_id: dados.id,
                reg_precosDataUpdate: new Date(),

                reg_precosCodigoBarra: reg_preco.reg_precosCodigoBarra,
                reg_precosProduto: reg_preco.reg_precosProduto,
                reg_precosPrecoAtual: reg_preco.reg_precosPrecoAtual,
                reg_precosPrecoNovo: reg_preco.reg_precosPrecoNovo,
                reg_precosPeriodo: reg_preco.reg_precosPeriodo,
                reg_precosMotivo: reg_preco.reg_precosMotivo,
                reg_precosSolicitante: reg_preco.reg_precosSolicitante,
                reg_precosResponsavel: reg_preco.reg_precosResponsavel,
                reg_precosObservacao: reg_preco.reg_precosObservacao,
        ...
        if(this.state.loading){
            ...
            return (
                <View style={styles.container}>
                    <AddReg_preco {...this.state} isVisible={this.state.showAdd} 
                        onSave={this.updateReg_precos}
                    ...
                    <View style={styles.taksContainer}>
                        <Text style={styles.titletela}>Controle de Reg_preco</Text>
                        <View style={styles.linha} />
                    </View>
